...
public class CellTest
{
    ...
    {
        Mover mover = new Player(new Point(0, 0), null);
    ...
    {
        Mover mover = new Bubble(new Point(0, 0), new Point(0, 5), null);
    ...
    {
        Mover mover = new Bubble(new Point(0, 0), new Point(0, 0), null);
